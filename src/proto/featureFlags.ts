...
export interface ProtoGrpcType {
  featureFlags: {
    ...
    EppoFeatureFlagService: SubtypeConstructor<typeof grpc.Client, _featureFlags_EppoFeatureFlagServiceClient> & { service: _featureFlags_EppoFeatureFlagServiceDefinition }
